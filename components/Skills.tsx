...
import { 
  Code2, Layers, Globe, Database, Terminal, Server, 
  GitBranch, Cpu, Workflow, CloudLightning, Boxes, 
  Container, Activity 
} from "lucide-react";
...
const SKILLS_DATA = [
  ...
  },
  {
    ...
    skills: [
      { name: "AWS Services", level: "Intermediate", icon: CloudLightning },
      { name: "Docker containers", level: "Intermediate", icon: Container },
      { name: "CI/CD Pipelines", level: "Intermediate", icon: Workflow },
      { name: "Linux & Scripting", level: "Intermediate", icon: Terminal },
      { name: "Infrastructure Monitoring", level: "Intermediate", icon: Activity },
      { name: "Vercel / Neon Cloud", level: "Intermediate", icon: Globe },
    ]
  }
];
...
export default function Skills() {
  return (
    <section id="skills" className="w-full py-20 bg-background transition-colors duration-300">
      <div className="max-w-6xl w-full mx-auto px-6">
        ...
        >
          <h2 className="text-3xl font-bold text-foreground tracking-tight mb-3">Technical Skills</h2>
          <p className="text-foreground/70 text-sm">
            Proficient in modern web technologies, secure backend systems, and automated cloud deployments.
          </p>
        </motion.div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full ${
                          skill.level === "Expert" ? "bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400" :
                          skill.level === "Advanced" ? "bg-green-50 dark:bg-green-950/60 text-green-600 dark:text-green-400" :
                          skill.level === "Intermediate" ? "bg-amber-50 dark:bg-amber-950/60 text-amber-600 dark:text-amber-400" :
