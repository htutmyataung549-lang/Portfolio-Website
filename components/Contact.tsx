  ...
  return (
    <section id="contact" className="py-20 bg-background transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <h2 className="text-3xl font-bold text-foreground tracking-tight mb-3">Get In Touch</h2>
        ...
        >
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div>
              ...
              />
              {errors.message && (
                <p className="text-xs text-red-500 mt-1.5 font-medium">{errors.message.message}</p>
              )}
            </div>
